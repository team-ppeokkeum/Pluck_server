package com.example.pluck_server.global.error;
...
public class GlobalExceptionHandler {
    ...
    //비즈니스 로직에서의 에러
    @ExceptionHandler(PluckException.class)
    public ResponseEntity<ErrorResponse> handlePluckException(PluckException e) {
